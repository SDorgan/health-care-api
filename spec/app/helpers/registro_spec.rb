...
describe 'Registro' do
  ...
  it 'deberia poder registrar el afiliado' do
    afiliado = @registro.registrar(nombre_afiliado: 'Juan', nombre_plan: 'Neo',
  ...
  it 'deberia poder devolver error plan no existente cuando es inexistente' do
    expect do
      @registro.registrar(nombre_afiliado: 'Juan', nombre_plan: 'noExiste',
                          id_telegram: 'fake_id', edad: 20,
                          cantidad_hijos: 0, conyuge: false)
  ...
  it 'deberia poder devolver error limite edad cuando supera el limite' do
    expect do
      @registro.registrar(nombre_afiliado: 'Juan', nombre_plan: 'Neo',
  ...
  it 'deberia poder devolver error por no tener conyuge cuando el plan lo requiere' do
    expect do
      @registro.registrar(nombre_afiliado: 'Juan', nombre_plan: 'PlanFamiliar',
                          id_telegram: 'fake_id', edad: 18,
                          cantidad_hijos: 0, conyuge: false)
  ...
  it 'deberia poder devolver error por no tener hijos cuando el plan lo requiere' do
    expect do
      @registro.registrar(nombre_afiliado: 'Juan', nombre_plan: 'PlanFamiliarConHijos',
                          id_telegram: 'fake_id', edad: 18,
                          cantidad_hijos: 0, conyuge: true)
