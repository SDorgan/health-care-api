...
Característica: Centros Cercanos
  ...
  Escenario: CCC1 - Consulta por cercanía cuando hay dos centros devuelve el más cercano
    ...
    Y se registra el centro
    Cuando consulto por centros cercanos a latitud "-34.117793" y longitud "-58.968414" existiendo dos centros
    Entonces el centro más cercano es el "Hospital Aleman"
...
@wip
  Escenario: CCC3 - Consulta por cercanía cuando hay cuatro centros devuelve el más cercano
    ...
    Y se registra el centro
    Cuando consulto por centros cercanos a latitud "-34.117793" y longitud "-58.968414" existiendo cuatro centros
